...
</code></pre></div><h3 id="finalhandler-req-res-options"><a href="#finalhandler-req-res-options" class="header-anchor">#</a> finalhandler(req, res, [options])</h3> <p>Returns function to be invoked as the final step for the given <code>req</code> and <code>res</code>.<br>
This function is to be invoked as <code>fn(err)</code>. If <code>err</code> is falsy, the handler will<br>
write out a 404 response to the <code>res</code>. If it is truthy, an error response will<br>
be written out to the <code>res</code>.</p> <p>When an error is written, the following information is added to the response:</p> <ul><li>The <code>res.statusCode</code> is set from <code>err.status</code> (or <code>err.statusCode</code>). If<br>
this value is outside the 4xx or 5xx range, it will be set to 500.</li> <li>The <code>res.statusMessage</code> is set according to the status code.</li> <li>The body will be the HTML of the status code message if <code>env</code> is<br> <code>'production'</code>, otherwise will be <code>err.stack</code>.</li> <li>Any headers specified in an <code>err.headers</code> object.</li></ul> <p>The final handler will also unpipe anything from <code>req</code> when it is invoked.</p> <h4 id="options-env"><a href="#options-env" class="header-anchor">#</a> options.env</h4> <p>By default, the environment is determined by <code>NODE_ENV</code> variable, but it can be<br>
overridden by this option.</p> <h4 id="options-onerror"><a href="#options-onerror" class="header-anchor">#</a> options.onerror</h4> <p>Provide a function to be called with the <code>err</code> when it exists. Can be used for<br>
writing errors to a central location without excessive function generation. Called<br>
...
<span class="token punctuation">}</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/110.0cde913d.js" defer></script>
  </body>
</html>
