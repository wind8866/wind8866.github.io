...
<ul><li>Accepts custom function</li> <li>Accepts IPv4/IPv6 address(es)</li> <li>Accepts subnets</li> <li>Accepts pre-defined names</li></ul></li> <li>Add optional <code>trust</code> argument to <code>proxyaddr.all</code> to<br>
stop at first untrusted</li> <li>Add <code>proxyaddr.compile</code> to pre-compile <code>trust</code> function<br>
to make subsequent calls faster</li></ul> <h1 id="_0-0-1-2014-05-04"><a href="#_0-0-1-2014-05-04" class="header-anchor">#</a> 0.0.1 / 2014-05-04</h1> <ul><li>Fix bad npm publish</li></ul> <h1 id="_0-0-0-2014-05-04"><a href="#_0-0-0-2014-05-04" class="header-anchor">#</a> 0.0.0 / 2014-05-04</h1> <ul><li>Initial release</li></ul></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/143.f36e30af.js" defer></script>
  </body>
</html>
