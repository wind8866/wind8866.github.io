...
</code></pre></div><h3 id="mime-contenttype-type"><a href="#mime-contenttype-type" class="header-anchor">#</a> mime.contentType(type)</h3> <p>Create a full content-type header given a content-type or extension.<br>
When given an extension, <code>mime.lookup</code> is used to get the matching<br>
content-type, otherwise the given content-type is used. Then if the<br>
content-type does not already have a <code>charset</code> parameter, <code>mime.charset</code><br>
...
mime<span class="token punctuation">.</span><span class="token function">contentType</span><span class="token punctuation">(</span>path<span class="token punctuation">.</span><span class="token function">extname</span><span class="token punctuation">(</span><span class="token string">'/path/to/file.json'</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token comment">// 'application/json; charset=utf-8'</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/130.046cbb37.js" defer></script>
  </body>
</html>
