...
<span class="token comment">//exp = /^\/foo\/(?:([^\/]+?))\/?$/i</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/142.dc421e7a.js" defer></script>
  </body>
</html>
