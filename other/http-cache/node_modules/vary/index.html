...
</code></pre></div><h3 id="vary-res-field"><a href="#vary-res-field" class="header-anchor">#</a> vary(res, field)</h3> <p>Adds the given header <code>field</code> to the <code>Vary</code> response header of <code>res</code>.<br>
This can be a string of a single field, a string of a valid <code>Vary</code><br>
header, or an array of multiple fields.</p> <p>This will append the header if not already listed, otherwise leaves<br>
...
</code></pre></div><h3 id="vary-append-header-field"><a href="#vary-append-header-field" class="header-anchor">#</a> vary.append(header, field)</h3> <p>Adds the given header <code>field</code> to the <code>Vary</code> response header string <code>header</code>.<br>
This can be a string of a single field, a string of a valid <code>Vary</code> header,<br>
or an array of multiple fields.</p> <p>This will append the header if not already listed, otherwise leaves<br>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/173.6113670d.js" defer></script>
  </body>
</html>
