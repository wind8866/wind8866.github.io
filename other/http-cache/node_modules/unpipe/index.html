...
</code></pre></div><h3 id="unpipe-stream"><a href="#unpipe-stream" class="header-anchor">#</a> unpipe(stream)</h3> <p>Unpipes all destinations from a given stream. With stream 2+, this is<br>
equivalent to <code>stream.unpipe()</code>. When used with streams 1 style streams<br>
(typically Node.js 0.8 and below), this module attempts to undo the<br>
actions done in <code>stream.pipe(dest)</code>.</p> <h2 id="license"><a href="#license" class="header-anchor">#</a> License</h2> <p><a href="LICENSE">MIT</a></p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/170.dd5b9669.js" defer></script>
  </body>
</html>
