...
</code></pre></div><h3 id="encodeurl-url"><a href="#encodeurl-url" class="header-anchor">#</a> encodeUrl(url)</h3> <p>Encode a URL to a percent-encoded form, excluding already-encoded sequences.</p> <p>This function will take an already-encoded URL and encode all the non-URL<br>
code points (as UTF-8 byte sequences). This function will not encode the<br>
&quot;%&quot; character unless it is not part of a valid sequence (<code>%20</code> will be<br>
left as-is, but <code>%foo</code> will be encoded as <code>%25foo</code>).</p> <p>This encode is meant to be &quot;safe&quot; and does not throw errors. It will try as<br>
hard as it can to properly encode the given URL, including replacing any raw,<br>
unpaired surrogate pairs with the Unicode replacement character prior to<br>
encoding.</p> <p>This function is <em>similar</em> to the intrinsic function <code>encodeURI</code>, except it<br>
will not encode the <code>%</code> character if that is part of a valid sequence, will<br>
not encode <code>[</code> and <code>]</code> (for IPv6 hostnames) and will replace raw, unpaired<br>
...
$ <span class="token function">npm</span> run lint
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/103.2cb86a45.js" defer></script>
  </body>
</html>
