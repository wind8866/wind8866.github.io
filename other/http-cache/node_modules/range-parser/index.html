...
</code></pre></div><h3 id="parserange-size-header-options"><a href="#parserange-size-header-options" class="header-anchor">#</a> parseRange(size, header, options)</h3> <p>Parse the given <code>header</code> string where <code>size</code> is the maximum size of the resource.<br>
...
</code></pre></div><h4 id="options"><a href="#options" class="header-anchor">#</a> Options</h4> <p>These properties are accepted in the options object.</p> <h5 id="combine"><a href="#combine" class="header-anchor">#</a> combine</h5> <p>Specifies if overlapping &amp; adjacent ranges should be combined, defaults to <code>false</code>.<br>
When <code>true</code>, ranges will be combined and returned as if they were specified that<br>
...
<span class="token comment">//    ]</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/148.c5bef4c6.js" defer></script>
  </body>
</html>
