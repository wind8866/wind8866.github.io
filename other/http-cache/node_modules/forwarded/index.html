...
</code></pre></div><p>Parse the <code>X-Forwarded-For</code> header from the request. Returns an array<br>
of the addresses, including the socket address for the <code>req</code>, in reverse<br>
order (i.e. index <code>0</code> is the socket address and the last index is the<br>
furthest address, typically the end-user).</p> <h2 id="testing"><a href="#testing" class="header-anchor">#</a> Testing</h2> <div class="language-sh extra-class"><pre class="language-sh"><code>$ <span class="token function">npm</span> <span class="token builtin class-name">test</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/112.e7193085.js" defer></script>
  </body>
</html>
