...
</code></pre></div><h2 id="api"><a href="#api" class="header-anchor">#</a> API</h2> <p>This CommonJS module exports a single default function: <code>toIdentifier</code>.</p> <h3 id="toidentifier-string"><a href="#toidentifier-string" class="header-anchor">#</a> toIdentifier(string)</h3> <p>Given a string as the argument, it will be transformed according to<br>
the following rules and the new string will be returned:</p> <ol><li>Split into words separated by space characters (<code>0x20</code>).</li> <li>Upper case the first character of each word.</li> <li>Join the words together with no separator.</li> <li>Remove all non-word (<code>[0-9a-z_]</code>) characters.</li></ol> <h2 id="license"><a href="#license" class="header-anchor">#</a> License</h2> <p><a href="LICENSE">MIT</a></p> <h2 id=""><a href="#" class="header-anchor">#</a></h2></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/166.7895afb8.js" defer></script>
  </body>
</html>
