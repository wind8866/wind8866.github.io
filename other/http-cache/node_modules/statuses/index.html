...
</code></pre></div><h3 id="var-code-status-integer-string"><a href="#var-code-status-integer-string" class="header-anchor">#</a> var code = status(Integer || String)</h3> <p>If <code>Integer</code> or <code>String</code> is a valid HTTP code or status message, then the<br>
...
status<span class="token punctuation">.</span>retry<span class="token punctuation">[</span><span class="token number">503</span><span class="token punctuation">]</span> <span class="token comment">// =&gt; true</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/165.6bc61007.js" defer></script>
  </body>
</html>
