...
<html lang="en-US">
  ...
  GitHub
  <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a></div> <!----></nav>  <!----> </aside> <main class="page"> <div class="theme-default-content content__default"><p>Browser-friendly inheritance fully compatible with standard node.js<br> <a href="http://nodejs.org/api/util.html#util_util_inherits_constructor_superconstructor" target="_blank" rel="noopener noreferrer">inherits<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>.</p> <p>This package exports standard <code>inherits</code> from node.js <code>util</code> module in<br>
node environment, but also provides alternative browser-friendly<br>
implementation through <a href="https://gist.github.com/shtylman/4339901" target="_blank" rel="noopener noreferrer">browser<br>
field<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>. Alternative<br>
implementation is a literal copy of standard one located in standalone<br>
module to avoid requiring of <code>util</code>. It also has a shim for old<br>
browsers with no <code>Object.create</code> support.</p> <p>While keeping you sure you are using standard <code>inherits</code><br>
implementation in node.js environment, it allows bundlers such as<br> <a href="https://github.com/substack/node-browserify" target="_blank" rel="noopener noreferrer">browserify<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a> to not<br>
include full <code>util</code> package to your client code if all you need is<br>
just <code>inherits</code> function. It worth, because browser shim for <code>util</code><br>
package is large and <code>inherits</code> is often the single function you need<br>
from it.</p> <p>It's recommended to use this package instead of<br> <code>require('util').inherits</code> for any code that has chances to be used<br>
...
</code></pre></div><h2 id="note-on-version-1-0"><a href="#note-on-version-1-0" class="header-anchor">#</a> note on version ~1.0</h2> <p>Version ~1.0 had completely different motivation and is not compatible<br>
neither with 2.0 nor with standard node.js <code>inherits</code>.</p> <p>If you are using version ~1.0 and planning to switch to ~2.0, be<br>
careful:</p> <ul><li>new version uses <code>super_</code> instead of <code>super</code> for referencing<br>
superclass</li> <li>new version overwrites current prototype while old one preserves any<br>
existing fields on it</li></ul></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/158.de953b27.js" defer></script>
  </body>
</html>
