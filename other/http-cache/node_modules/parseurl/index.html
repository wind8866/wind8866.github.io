...
</code></pre></div><h3 id="parseurl-req"><a href="#parseurl-req" class="header-anchor">#</a> parseurl(req)</h3> <p>Parse the URL of the given request object (looks at the <code>req.url</code> property)<br>
and return the result. The result is the same as <code>url.parse</code> in Node.js core.<br>
Calling this function multiple times on the same <code>req</code> where <code>req.url</code> does<br>
not change will return a cached parsed object, rather than parsing again.</p> <h3 id="parseurl-original-req"><a href="#parseurl-original-req" class="header-anchor">#</a> parseurl.original(req)</h3> <p>Parse the original URL of the given request object and return the result.<br>
This works by trying to parse <code>req.originalUrl</code> if it is a string, otherwise<br>
parses <code>req.url</code>. The result is the same as <code>url.parse</code> in Node.js core.<br>
Calling this function multiple times on the same <code>req</code> where <code>req.originalUrl</code><br>
...
<span class="token operator">&gt;</span> node benchmark/slash.js
  ...
  parseurl           x <span class="token number">42,279</span>,067 ops/sec ±0.55% <span class="token punctuation">(</span><span class="token number">190</span> runs sampled<span class="token punctuation">)</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/140.0101e64d.js" defer></script>
  </body>
</html>
