...
<html lang="en-US">
  ...
  <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a></div> <!----></nav>  <!----> </aside> <main class="page"> <div class="theme-default-content content__default"><h1 id="_0-5-2-2017-09-13"><a href="#_0-5-2-2017-09-13" class="header-anchor">#</a> 0.5.2 / 2017-09-13</h1> <ul><li>Fix regression matching multiple ETags in <code>If-None-Match</code></li> <li>perf: improve <code>If-None-Match</code> token parsing</li></ul> <h1 id="_0-5-1-2017-09-11"><a href="#_0-5-1-2017-09-11" class="header-anchor">#</a> 0.5.1 / 2017-09-11</h1> <ul><li>Fix handling of modified headers with invalid dates</li> <li>perf: improve ETag match loop</li></ul> <h1 id="_0-5-0-2017-02-21"><a href="#_0-5-0-2017-02-21" class="header-anchor">#</a> 0.5.0 / 2017-02-21</h1> <ul><li>Fix incorrect result when <code>If-None-Match</code> has both <code>*</code> and ETags</li> <li>Fix weak <code>ETag</code> matching to match spec</li> <li>perf: delay reading header values until needed</li> <li>perf: skip checking modified time if ETag check failed</li> <li>perf: skip parsing <code>If-None-Match</code> when no <code>ETag</code> header</li> <li>perf: use <code>Date.parse</code> instead of <code>new Date</code></li></ul> <h1 id="_0-4-0-2017-02-05"><a href="#_0-4-0-2017-02-05" class="header-anchor">#</a> 0.4.0 / 2017-02-05</h1> <ul><li>Fix false detection of <code>no-cache</code> request directive</li> <li>perf: enable strict mode</li> <li>perf: hoist regular expressions</li> <li>perf: remove duplicate conditional</li> <li>perf: remove unnecessary boolean coercions</li></ul> <h1 id="_0-3-0-2015-05-12"><a href="#_0-3-0-2015-05-12" class="header-anchor">#</a> 0.3.0 / 2015-05-12</h1> <ul><li>Add weak <code>ETag</code> matching support</li></ul> <h1 id="_0-2-4-2014-09-07"><a href="#_0-2-4-2014-09-07" class="header-anchor">#</a> 0.2.4 / 2014-09-07</h1> <ul><li>Support Node.js 0.6</li></ul> <h1 id="_0-2-3-2014-09-07"><a href="#_0-2-3-2014-09-07" class="header-anchor">#</a> 0.2.3 / 2014-09-07</h1> <ul><li>Move repository to jshttp</li></ul> <h1 id="_0-2-2-2014-02-19"><a href="#_0-2-2-2014-02-19" class="header-anchor">#</a> 0.2.2 / 2014-02-19</h1> <ul><li>Revert &quot;Fix for blank page on Safari reload&quot;</li></ul> <h1 id="_0-2-1-2014-01-29"><a href="#_0-2-1-2014-01-29" class="header-anchor">#</a> 0.2.1 / 2014-01-29</h1> <ul><li>Fix for blank page on Safari reload</li></ul> <h1 id="_0-2-0-2013-08-11"><a href="#_0-2-0-2013-08-11" class="header-anchor">#</a> 0.2.0 / 2013-08-11</h1> <ul><li>Return stale for <code>Cache-Control: no-cache</code></li></ul> <h1 id="_0-1-0-2012-06-15"><a href="#_0-1-0-2012-06-15" class="header-anchor">#</a> 0.1.0 / 2012-06-15</h1> <ul><li>Add <code>If-None-Match: *</code> support</li></ul> <h1 id="_0-0-1-2012-06-10"><a href="#_0-0-1-2012-06-10" class="header-anchor">#</a> 0.0.1 / 2012-06-10</h1> <ul><li>Initial release</li></ul></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/113.6a815f50.js" defer></script>
  </body>
</html>
