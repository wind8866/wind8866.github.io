...
</code></pre></div><p>Parse a content type string. This will return an object with the following<br>
properties (examples are shown for the string <code>'image/svg+xml; charset=utf-8'</code>):</p> <ul><li><p><code>type</code>: The media type (the type and subtype, always lower case).<br>
Example: <code>'image/svg+xml'</code></p></li> <li><p><code>parameters</code>: An object of the parameters in the media type (name of parameter<br>
...
parameter will be lower-cased). Example: <code>{charset: 'utf-8'}</code></p></li></ul> <p>Throws a <code>TypeError</code> if the object contains an invalid type or parameter names.</p> <h2 id="license"><a href="#license" class="header-anchor">#</a> License</h2> <p><a href="LICENSE">MIT</a></p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/91.0c4f8a41.js" defer></script>
  </body>
</html>
