...
</code></pre></div><h2 id="api"><a href="#api" class="header-anchor">#</a> API</h2> <p>This is the current API, currently extracted from Koa and subject to change.</p> <h3 id="error-properties"><a href="#error-properties" class="header-anchor">#</a> Error Properties</h3> <ul><li><code>expose</code> - can be used to signal if <code>message</code> should be sent to the client,<br>
defaulting to <code>false</code> when <code>status</code> &gt;= 500</li> <li><code>headers</code> - can be an object of header names to values to be sent to the<br>
client, defaulting to <code>undefined</code>. When defined, the key names should all<br>
be lower-cased</li> <li><code>message</code> - the traditional error message, which should be kept short and all<br>
single line</li> <li><code>status</code> - the status code of the error, mirroring <code>statusCode</code> for general<br>
compatibility</li> <li><code>statusCode</code> - the status code of the error, defaulting to <code>500</code></li></ul> <h3 id="createerror-status-message-properties"><a href="#createerror-status-message-properties" class="header-anchor">#</a> createError([status], [message], [properties])</h3> <p>Create a new error object with the given message <code>msg</code>.<br>
...
</code></pre></div><ul><li><code>status: 500</code> - the status code as a number</li> <li><code>message</code> - the message of the error, defaulting to node's text for that status code.</li> <li><code>properties</code> - custom properties to attach to the object</li></ul> <h3 id="createerror-status-error-properties"><a href="#createerror-status-error-properties" class="header-anchor">#</a> createError([status], [error], [properties])</h3> <p>Extend the given <code>error</code> object with <code>createError.HttpError</code><br>
properties. This will not alter the inheritance of the given<br> <code>error</code> object, and the modified <code>error</code> object is the<br>
...
The error object inherits from <code>createError.HttpError</code>.</p> <div class="language-js extra-class"><pre class="language-js"><code><span class="token keyword">var</span> err <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">createError<span class="token punctuation">.</span>NotFound</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    ...
    <script src="/assets/js/app.2e3db3d9.js" defer></script><script src="/assets/js/2.65dda3ac.js" defer></script><script src="/assets/js/116.8b100930.js" defer></script>
  </body>
</html>
